  ...
  return (
    <div style={{ minHeight: "100vh", background: C.cream, fontFamily: font }}>
      ...
      <div className="bp-main">
        <div className="bp-grid">
          ...
          <div className="bp-sidebar">
            ...
            {/* Educational block 2: Write Because soft intro */}
            <div style={{ background: C.navy, borderRadius: 14, padding: "20px", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.65)", fontFamily: font, lineHeight: 1.7, margin: "0 0 16px", position: "relative" }}>
                Write Because automates it. Real handwritten notes, real pen on paper, mailed to your list. From $2.50 a card including postage.
              </p>
              <a href="https://writebecause.com" target="_blank" rel="noreferrer" style={{ display: "block", textAlign: "center", background: C.gold, color: C.navy, textDecoration: "none", fontWeight: 800, fontSize: 15, padding: "10px 14px", borderRadius: 8, fontFamily: font, position: "relative" }}>
      ...
      <footer style={{ background: C.navy, color: "rgba(255,255,255,0.4)", textAlign: "center", padding: "18px 24px", fontSize: 12, fontFamily: font }}>
        Powered by{" "}
        <a href="https://writebecause.com" style={{ color: "rgba(201,151,58,0.75)", textDecoration: "none", fontWeight: 600 }}>WriteBecause.com</a>
